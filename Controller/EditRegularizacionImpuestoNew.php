 ...
 */
class EditRegularizacionImpuestoNew extends EditController
{
    /** @var ?Modelo303 */
     ...
     * @return void
     */
    protected function createViewsTaxDetail(string $viewName = 'ListPartidaImpuestoResumenNew'): void
    {
        $this->addListView($viewName, 'Join\PartidaImpuestoResumenNew', 'tax-detail');
        $this->disableButtons($viewName, true);
    }
    ...
    protected function loadData($viewName, $view): void
    {
        switch ($viewName) {
            ...
            case 'ListPartidaImpuestoResumenNew':
